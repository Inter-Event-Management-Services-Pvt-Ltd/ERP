...
description: Use when reviewing IEMS ERP frontend authentication, protected routes, file downloads, forms, third-party packages, security headers, metadata exposure, error messages, or browser storage. Codex frontend-only skill.
---
