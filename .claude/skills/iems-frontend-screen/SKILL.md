...
description: Use when designing or implementing an IEMS ERP frontend screen, route, component, dashboard, table, form, file explorer, archive view, task view, attendance view, or approval screen. Claude frontend-only skill.
---
...
→ use either Claude Design or Google Stitch where helpful
