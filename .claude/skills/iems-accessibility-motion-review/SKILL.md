...
description: Use when reviewing or implementing IEMS ERP frontend accessibility, transitions, animation, responsive behavior, keyboard navigation, focus handling, or reduced-motion behavior. Claude frontend-only skill.
---
